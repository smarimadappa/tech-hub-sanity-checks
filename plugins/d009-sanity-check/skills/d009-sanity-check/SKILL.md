...
This is informational only — it does NOT change the ✅ / ⏳ / 🚨 header, does NOT escalate or
page on-call on its own (the standard On-call tag is always present), and is NOT itself a pass/fail check. (Source vs. destination may
